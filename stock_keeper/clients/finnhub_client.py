...
class FinnhubClient:
    ...
    def __init__(self, api_key, cache_path=None, proxies=None):
    ...
    def _request(self, method, path, **kwargs):
        ...
        kwargs["params"] = self._merge_two_dicts({"token": self._api_key}, kwargs.get("params", {}))
        kwargs["params"] = self._format_params(kwargs["params"])
    ...
    def get_historical_prices(self, symbol, from_ts, to_ts, resolution='D'):
        return self.stock_candles(symbol, resolution, from_ts, to_ts)

    def get_company_profile(self, symbol):
        return self.company_profile(symbol=symbol)

    def get_news(self, symbol, from_dt, to_dt):
        return self.company_news(symbol, from_dt, to_dt)